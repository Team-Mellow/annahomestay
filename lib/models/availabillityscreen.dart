...
class _AvailabilityScreenState extends State<AvailabilityScreen> {
  ...
  Map<String, Map<String, dynamic>> availability = {}; // Modified to include price and capacity
  List<String> homestayNames = [];
  List<Map<String, dynamic>> homestayDetails = [];
  ...
  Future<void> _loadHomestayDetails() async {
    try {
      var details = await HomestayRepository.instance.fetchHomestayDetails();
      setState(() {
              ...
              children: [
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                      primary: Colors.indigo[900]), // Dark blue button
                ),
                Text(
                  checkInDate == null
                      ? 'Not selected'
